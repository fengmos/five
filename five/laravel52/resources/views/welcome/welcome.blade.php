...
<div style=" margin-bottom:110px;">
    ...
    <tr>
      ...
      <td>
      <a href="{{URL('question')}}" style="color:black; text-decoration:none;">
            <div style="margin:10px auto;width:40px;height:40px;border-radius:40px;overflow:hidden;">
                <img src="{{asset('style/img/05.jpg')}}" style="margin:0;width:100%;height:100%;">
            </div>
            <p style="font-size:11px; text-align:center">问答</p>
        </a> 
      </td>
      <td>
      <a href="{{URL('notes')}}" style="color:black; text-decoration:none;">
            <div style="margin:10px auto;width:40px;height:40px;border-radius:40px;overflow:hidden;">
                <img src="{{asset('style/img/06.jpg')}}" style="margin:0;width:100%;height:100%;">
            </div>
