...
<!--内容-->   
   ...
   <ion-scroll  direction="y" scrollbar-y="false" style="width: 100%; height: 100%">
             ...
             <?php foreach($heat as $key=>$val){?>
       <div class="NewsList">
        <ul class="clearfix classul">    
                 <li>
                    <div class="bord">
                        <div class="lt">
                            <a href="<?php echo e(url('cont')); ?>?cur_id=<?php echo $val['cur_id']?>" title=""><img src="http://admin.duzejun.cn/<?php echo $val['cur_img'];?>" height="50px;" width='50px;' alt=""/></a>
                        </div>
                        <div class="rt">
                            <a href="#" title="">
                                <div class="rt1">
