...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/weui.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/book.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/swipe.css')); ?>">
        ...
        <div class="InsD_table">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td class="f14 gray1">
                        <a href="<?php echo e(url('detamils')); ?>?id=<?php echo e($id); ?>" class="gray1" target="_blank">
                            <?=$curone['teacher_name']?>
                        </a>
                    </td>
                </tr>
                ...
                <?php foreach($kejie['pp'] as $key=>$val){?>
                    ...
                    <?php foreach($val['pp'] as $k=>$v){?>
                         <dd>
                             ...
                             <?php }else{ ?>
                             <a href="<?php echo e(URL('bfang')); ?>?fid=<?=$v['id']?>&cur_id=<?=$curone['cur_id']?>" ids="<?=$v['id']?>" class="bfang">
                                 <?=$v['file_name']?>
                             </a>
                             <?php }?>
                         </dd>
...
<!-- 底部-->
<?php /*<?php echo $__env->make('master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>*/ ?>
<script src="<?php echo e(asset('js/swipe.min.js')); ?>" charset="utf-8"></script>
<script src="<?php echo e(asset('js/book.js')); ?>" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo e(asset('style/layer/layer.js')); ?>"></script>
<script>
$(function(){
    ...
    $.ajax({
   type: "GET",
   url: "<?php echo e(URL('select_cart')); ?>",
   data: {id:id},
   success: function(msg){
    ...
    $("#look").click(function(){
        location.href="<?php echo e(URL('mycart')); ?>";
    })
})
    function togobegen(){
    ...
    function _toCharge(id){
        var user_session = "<?=$session->get('nickname');?>";
          ...
          }else
          {
            ...
            $.post("<?php echo e(URL('addcart')); ?>",{'_token':'<?php echo e(csrf_token()); ?>','id':id},function(data){
                if(data.status == 0){
