    ...
    <div style="display:none;" id="user_info">
             <div style="width:70px;height:70px;"></div>
              <div style="margin:10px auto;width:100px;height:100px;border-radius:50px;overflow:hidden;">
                    <img src="<?php echo e($arr['img']); ?>" style="margin:0;width:100%;height:100%;">
              </div>

                   <p style="text-align:center">昵称：<?php echo e($arr['nickname']); ?></p>
              <div>

                 <ul class="list">
                  <li class="item  item-button-right icon ion-ios-person-outline">
                        <a class="button button-clear icon " href="<?php echo e(URL('myinfo')); ?>" style="margin-right:150px;color:#000;">个人信息</a>
                    </li>
                    <li  class="item  item-button-right icon ion-ios-folder-outline">
                      <a class="button button-clear icon " href="<?php echo e(URL('mycart')); ?>" style="margin-right:130px;color:#000;">我的购物车</a>
                    </li>
                     <li  class="item  item-button-right icon ion-ios-folder-outline">
                     <a class="button button-clear icon " href="<?php echo e(URL('myorder')); ?>" style="margin-right:130px;color:#000;">已购买课程</a>
                    </li>
                    <li class="item item-button-right icon ion-ios-star-outline">
                      <a class="button button-clear icon " href="<?php echo e(URL('personal')); ?>" style="margin-right:150px;color:#000;">我的收藏</a>
                    </li>
                     
                    <li class="item  item-button-right icon ion-ios-person-outline">
                  <a class="button button-clear icon " href="<?php echo e(URL('feedback')); ?>" style="margin-right:150px;color:#000;">意见反馈</a>
     ...
     <div style="display:none;" id="user_login">
             <div style="width:70px;height:70px;"></div>
                  <a href="<?php echo e(URL('login')); ?>"> <p style="text-align:center"><button class="duoxue" style="width:150px;height:50px;">登录多学网</button></p></a>
              <div>
              <div>
...
<script>
  $(function(){
     var user_session = "<?php echo e($session->get('nickname')); ?>";
    if(user_session == '')
    {
       $("#user_login").show();
       $("#user_info").hide();
