...
<div class="scroll-content padding" id="index_login">
	<form action="<?php echo e(URL('add')); ?>" method="post" id="form">
			<div class="list list-borderless">
				<div class="item item-image">
					<img src="<?php echo e(asset('style/img/1a.png')); ?>" style="background-size: 100% 100% ;">
				</div>
			</div>
		  <div class="list list-inset">
			  ...
			  <label class="item item-input" style="margin-top: 20px;">
				  ...
				  <?php /*<a href="javascript:void(0);" style="text-decoration: none;color:#0080FF;" id="btn">点击发送验证码</a>*/ ?>
