...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('style/css/ionic.css')); ?>">  
...
<div class="scroll-content padding" id="index_login">
			...
			<div class="list list-borderless">
				...
				<img src="<?php echo e(asset('style/img/1a.png')); ?>" style="margin:0;width:100%;height:100%;border-radius:50px;overflow:hidden;">
	...
	<form action="<?php echo e(URL('checklogin')); ?>" method="post">
	  ...
	  <button class="button button-block button-positive" type="submit">登陆 </button>
	   ...
	   <a class="button button-block button-positive" href="<?php echo e(URL('regist')); ?>">注册 </a>
	<div class="info" style="margin-left: 140px;">
		<?php if(session('errors')): ?>
			<p style="font-size: 16px; color:red;" id="errorInfo"><?php echo e(session('errors')); ?></p>
		<?php endif; ?>
	</div>
	<div style="float: left;margin-left: 80px;margin-top: 30px">
		<a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101371415&redirect_uri=http://xiaodu.duzejun.cn/&state=test&display=mobile">
			<img src="<?php echo e(asset('style/img/qq222.png')); ?>">
		</a>
	</div>
	<div style="margin-left: 80px;float: left;margin-top: 30px">
	<a href="https://api.weibo.com/oauth2/authorize?client_id=61581137&redirect_uri=http://home.duzejun.cn/weibo&display=mobile"><img src="<?php echo e(asset('style/img/weibo.png')); ?>" alt=""></a>
</div>
	</div>
</body>
</html>
<script src="<?php echo e(asset('style/js/jquery.js')); ?>"></script>